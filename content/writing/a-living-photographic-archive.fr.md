...
seo_title = "Une archive photographique vivante — Méthode et outils"
...
Cela évite de soumettre toute son archive aux conventions ou aux limites d’un catalogue particulier.
On peut ainsi utiliser les fonctionnalités de différentes photothèques ou logiciels spécialisés,
sans devoir reconstruire toute son organisation à chaque fois.
...
`Other` pour ce qui ne rentre nulle part ailleurs, mais ne mérite pas d’être supprimé.
...
Cette étape devient vite irréaliste à la main lorsqu’on traite beaucoup de fichiers. Elle repose sur
...
synchronisé, disque externe, NAS ou autre support. Ceux qui veulent aller plus loin peuvent prévoir
des checksums ou plusieurs copies, mais cela relève plutôt de la stratégie de sauvegarde que du cœur
de cette méthode.
...
personnelle avec des conventions simples, lisibles et durables, sans dépendre entièrement d’un cloud
...
J’ai transformé cette méthode en guide pratique, accompagné de quelques scripts Bash pour
automatiser les étapes les moins réalistes à faire à la main :
...
nommer les fichiers clairement, vérifier qu’ils s’ouvrent correctement, puis les organiser dans des
dossiers ordinaires.
